...
/// a LAN host on an older build can be told apart from the cloud.
 int? get protocolMinor; String get roomCode; Mode get mode; Phase get phase;/// Host clock (ms since epoch) when the snapshot was built.
...
switch (_that) {
case _RoomState() when $default != null:
return $default(_that.protocolVersion,_that.protocolMinor,_that.roomCode,_that.mode,_that.phase,_that.serverTime,_that.packTitles,_that.questionIndex,_that.questionCount,_that.gameNumber,_that.settings,_that.question,_that.deadline,_that.pausedRemainingMs,_that.acceptedAnswers,_that.players,_that.you,_that.submissions);case _:
  return orElse();
