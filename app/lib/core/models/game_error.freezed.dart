...
$GameErrorCopyWith<GameError> get copyWith => _$GameErrorCopyWithImpl<GameError>(this as GameError, _$identity);

  /// Serializes this GameError to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  final _this = this as GameError;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GameError&&(identical(other.code, _this.code) || other.code == _this.code)&&(identical(other.message, _this.message) || other.message == _this.message));
}
...
String toString() {
  final _this = this as GameError;
  return 'GameError(code: ${_this.code}, message: ${_this.message})';
}
...
/// @nodoc
abstract mixin class $GameErrorCopyWith<$Res>  {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GameError value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GameError() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GameError value)  $default,){
final _that = this;
switch (_that) {
case _GameError():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GameError value)?  $default,){
final _that = this;
switch (_that) {
case _GameError() when $default != null:
return $default(_that);case _:
...
class _GameError implements GameError {
  const _GameError({required this.code, this.message});
  factory _GameError.fromJson(Map<String, dynamic> json) => _$GameErrorFromJson(json);
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _GameError&&(identical(other.code, code) || other.code == code)&&(identical(other.message, message) || other.message == message));
}
...
/// @nodoc
abstract mixin class _$GameErrorCopyWith<$Res> implements $GameErrorCopyWith<$Res> {
