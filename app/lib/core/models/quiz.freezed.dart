...
mixin _$QuizDocument {
 ...
 int get formatVersion; String? get id; String? get slug; String get title; String? get description; String get language; String get category; List<String> get tags; String get source; String get visibility; bool get isOwner; QuizDefaultSettings get defaultSettings; int get questionCount; bool get hasPhotos; DateTime? get createdAt; DateTime? get updatedAt; List<QuizQuestion>? get questions;
...
int get hashCode {
  final _this = this as QuizDocument;
  return Object.hash(runtimeType,_this.formatVersion,_this.id,_this.slug,_this.title,_this.description,_this.language,_this.category,const DeepCollectionEquality().hash(_this.tags),_this.source,_this.visibility,_this.isOwner,_this.defaultSettings,_this.questionCount,_this.hasPhotos,_this.createdAt,_this.updatedAt,const DeepCollectionEquality().hash(_this.questions));
}

@override
String toString() {
  final _this = this as QuizDocument;
  return 'QuizDocument(formatVersion: ${_this.formatVersion}, id: ${_this.id}, slug: ${_this.slug}, title: ${_this.title}, description: ${_this.description}, language: ${_this.language}, category: ${_this.category}, tags: ${_this.tags}, source: ${_this.source}, visibility: ${_this.visibility}, isOwner: ${_this.isOwner}, defaultSettings: ${_this.defaultSettings}, questionCount: ${_this.questionCount}, hasPhotos: ${_this.hasPhotos}, createdAt: ${_this.createdAt}, updatedAt: ${_this.updatedAt}, questions: ${_this.questions})';
}
...
@useResult
$Res call({
 int formatVersion, String? id, String? slug, String title, String? description, String language, String category, List<String> tags, String source, String visibility, bool isOwner, QuizDefaultSettings defaultSettings, int questionCount, bool hasPhotos, DateTime? createdAt, DateTime? updatedAt, List<QuizQuestion>? questions
});
...
/// Create a copy of QuizDocument
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? formatVersion = null,Object? id = freezed,Object? slug = freezed,Object? title = null,Object? description = freezed,Object? language = null,Object? category = null,Object? tags = null,Object? source = null,Object? visibility = null,Object? isOwner = null,Object? defaultSettings = null,Object? questionCount = null,Object? hasPhotos = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? questions = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int formatVersion,  String? id,  String? slug,  String title,  String? description,  String language,  String category,  List<String> tags,  String source,  String visibility,  bool isOwner,  QuizDefaultSettings defaultSettings,  int questionCount,  bool hasPhotos,  DateTime? createdAt,  DateTime? updatedAt,  List<QuizQuestion>? questions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QuizDocument() when $default != null:
return $default(_that.formatVersion,_that.id,_that.slug,_that.title,_that.description,_that.language,_that.category,_that.tags,_that.source,_that.visibility,_that.isOwner,_that.defaultSettings,_that.questionCount,_that.hasPhotos,_that.createdAt,_that.updatedAt,_that.questions);case _:
  return orElse();
...
@override
int get hashCode {
    return Object.hash(runtimeType,formatVersion,id,slug,title,description,language,category,const DeepCollectionEquality().hash(_tags),source,visibility,isOwner,defaultSettings,questionCount,hasPhotos,createdAt,updatedAt,const DeepCollectionEquality().hash(_questions));
}

@override
String toString() {
    return 'QuizDocument(formatVersion: $formatVersion, id: $id, slug: $slug, title: $title, description: $description, language: $language, category: $category, tags: $tags, source: $source, visibility: $visibility, isOwner: $isOwner, defaultSettings: $defaultSettings, questionCount: $questionCount, hasPhotos: $hasPhotos, createdAt: $createdAt, updatedAt: $updatedAt, questions: $questions)';
}
